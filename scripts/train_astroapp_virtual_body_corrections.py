#!/usr/bin/env python3
"""Train external-ref current-version virtual-row body correction models.
...
These corrections are intended only for the external-ref-Alchabitius virtual-point
...
def main() -> None:
    ...
    for body_id, rows in body_rows.items():
        ...
        joblib.dump(payload, out_dir / f"external-ref_pd_virtual_body_corr_{BODY_NAMES[body_id]}_v1.joblib")
    ...
    (out_dir / "external-ref_pd_virtual_body_corr_summary_v1.json").write_text(
