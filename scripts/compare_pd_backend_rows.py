#!/usr/bin/env python3
"""Duplicate-aware validation: local Horosa PD rows vs external-ref dirs.csv.
...
external-ref uses signed aspect keys for ordinary object significators, but its
