...
def compare_case(case_dir: Path, mode: str, planet_only: bool) -> tuple[list[dict[str, Any]], dict[str, int]]:
...
def main() -> None:
    ...
    ap.add_argument("--mode", choices=["utc_sourcejd", "birth_fields"], default="utc_sourcejd")
    ...
    for case_dir in case_dirs:
        rows, counts = compare_case(case_dir, args.mode, args.planet_only)
    ...
    out_json.write_text(json.dumps(summary.__dict__, indent=2), encoding="utf-8")
