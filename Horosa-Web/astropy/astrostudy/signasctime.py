...
class SignAscTime:
    ...
    def getJDFromPDArc(self, arc):
        # external-ref is closer to symbolic-year interpolation than a tropical-year
    ...
    def getDateFromPDArc(self, arc):
        ...
        # external-ref dirs.csv exports dirDate in UTC-like display, not local chart time.
