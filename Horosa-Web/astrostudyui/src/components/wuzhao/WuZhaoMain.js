	...
	renderRightPanel(){
		...
		return (
			<Tabs activeKey={activeKey} onChange={this.setRightPanelTab} defaultActiveKey="overview" tabPosition="top" className="horosa-huangji-tabs">
				...
				<TabPane tab="断辞" key="duanci">{this.renderDuanci()}</TabPane>
				<TabPane tab="君子小人" key="junzi">{this.renderJunzi()}</TabPane>
				...
				<TabPane tab="类占" key="leizhan">{this.renderLeizhan()}</TabPane>
			</Tabs>
		);
	}
