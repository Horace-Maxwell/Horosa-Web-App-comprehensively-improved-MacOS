...
| 集成与精度校验 | `check_horosa_full_integration.py`、`check_india_jyotish_engine.py`、`check_local_ephemeris_precision.py`、`check_primary_direction_astroapp_integration.py`、`compare_pd_backend_rows.py` |
| 主限法反推 / 训练 | `primary_directions_reverse/auto_collect_astroapp_pd.py`、`train_astroapp_asc_case_correction.py`、`train_astroapp_virtual_body_corrections.py` |
...
- **杂项** —— `.DS_Store`、`*.log`、`*.tmp`、`default.profraw`、IDE 目录（`.vscode/`、`.idea/`）、`.private_astroapp_docs/`。
